...
We return to the music transcription problem of Example~\ref{ex:running}. 
Let $\Deltai$ be the subset of $\Delta$ without the markup symbols.
In order to align the input in $\Sigma^*$ %sequence 
with a music score v, we must take into consideration
