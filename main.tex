...
\begin{example}
... \SWVPA over the alphabet of Example~\ref{ex:nested-word}
...
*** SUPPR ***
For instance
\includegraphics[scale=0.20]{pictures/score5.png} will be favored
on \includegraphics[scale=0.20]{pictures/score4.png}. 
%
