...
\noindent
\philippe{Il me manque une explication:  on construit un automate
qui, étant donnée une partition $t$, renvoie la distance minimale
avec n'importe quelle performance (distance donnée par un transducer)?
Quel est le rôle de A(s)?
}
