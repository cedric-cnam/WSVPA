...
as functions of  
$Q \times (\Sigma \cup \{ \epsilon \}) \times (\Delta \cup \{ \epsilon \}) \times Q \to \Semiring$,
overloading the function names,
such that, for all $q, q' \in Q$, $a \in \Sigma$,  $b \in \Delta$, 
\[
\begin{array}{rcll}
\wei_{10}(q, a, \epsilon, q') & = & \phi(a) & %\wei_\Sigma(q, q')(a)
\quad\mathrm{where~} \phi = \wei_{10}(q, q') \in \Phi_\Sigma,\\
\wei_{01}(q, \epsilon, b, q') & = & \psi(b) & 
...
%
\begin{align}
\weight_T(q, \epsilon, \epsilon, q)  & = \final(q)\\
\weight_T(q, \epsilon, \epsilon, q') & = \zero \quad \mathrm{if~} q \neq q'\nonumber\\
\weight_T(q, au, \epsilon, q') & = \displaystyle\bigoplus_{q'' \in Q} 
    \wei_{10}(q, a, \epsilon, q'') \otimes \weight_T(q'', u, \epsilon, q')\nonumber\\
\weight_T(q, \epsilon, bv, q') & = \displaystyle\bigoplus_{q'' \in Q} 
    \wei_{01}(q, \epsilon, b, q'') \otimes \weight_T(q'', \epsilon, v, q')\nonumber\\
\weight_T(q, au, bv, q') & = \displaystyle\bigoplus_{q'' \in Q} 
    \wei_{10}(q, a, \epsilon, q'') \otimes \weight_T(q'', u, bv, q')\nonumber\\
                    & \oplus \displaystyle\bigoplus_{q'' \in Q} 
    \wei_{01}(q, \epsilon, b, q'') \otimes \weight_T(q'', au, v, q')\nonumber\\
                    & \oplus \displaystyle\bigoplus_{q'' \in Q} 
...
When $a = \epsilon$ (resp. $b = \epsilon$), the current symbol 
...
Intuitively, 
$\wei_{10}(q, a, \epsilon, r)$ is the cost of 
the deletion of the symbol~$a \in \Sigma$ in~$s$, 
$\wei{01}(q, \epsilon, b, r)$ is the cost 
...
\wei_{01}(q_0, \epsilon, \< \mathsf{-}, d'>, q_0) & = & \one & &
\wei_{01}(q_1, \epsilon, \< \mathsf{-}, d'>, q_0) & = & \one\\
\wei_{10}(q_0, d, \epsilon, q_1) & = & \alpha & & %\multicolumn{3}{l}{\mathrm{for~all~} b \in \Delta}
\end{array}
\]
%
...
%
\begin{align}
\weight_A(q, \epsilon, q) & = \final(q)\\
\weight_A(q, \epsilon, q') & = \zero \quad \mathrm{if~} q \neq q'\nonumber\\
...
%
The first steps in the sequence correspond to $\epsilon$-transitions of automata, 
...
with new transitions of the form $\wei_{01}(q, \epsilon, b, q')$.
