...
i.e., an ornemental note with theoretical duration~0.
\endex
\end{example}
...
in order to start the next sub-interval after reading $\creturn{d}$,
with the transition:
\(
\weir\bigl(q_{{d}/{d}},
...
\florent{compare expressiveness with register etc automata}
