...
\end{proposition}
\florent{AV: not needed $\bar\Phi$ effective}
%
\begin{proof}
\florent{proof: sketch and mv to app.?}
\input{app-closure}
%\qed
\end{proof}
...
rules can be weighted in the tropical semiring.
For instance, the following production rules define two possible divisions
of a time interval into respectively a duplet and a triplet.
\[
