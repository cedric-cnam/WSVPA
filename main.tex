...
The transition function $\wei'_1$ will roughly perform product of 
transitions defined by $\wei_1$, 
...
\noindent
For each $p_1\in P$ and $q_1, q_2 \in Q$, do let
\[
