...
and let $d_\bot(q_1, q_2) = d_\top(q_1, p, q_2) = \one$ if $q_1 = q_2$ and $d_\bot(q_1, q_2) = d_\top(q_1, p, q_2) = \zero$ otherwise$\;$
...
into a \SWVPA $A'$ over $\hat\Omega$, using Proposition~\ref{lem:SWTA}, 
