...
\end{definition}
%
Like in Section~\ref{sec:SWAdef}, we define a function~$\wei$ %from $\bar\wei$
from 
...
the weight of a production $q_0 \to a(q_1, \ldots, q_k)$ 
...
For all \SWTA $A$ over~$\Omega$ and $\Semiring$, 
there exists an effectively constructible \SWVPA $A'$ 
