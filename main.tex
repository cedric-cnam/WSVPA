...
% - author=name
\newcommand{\mynote}[1]{\todo[noline,size=\tiny,color=yellow!40]{#1}}
\newcommand{\lydia}[1]{\todo[noline,size=\tiny,color=red!40]{#1}}
\newcommand{\philippe}[1]{\todo[noline,size=\tiny,color=blue!40]{#1}}
...
\mynote{revise with nb of tr. and states}
...
\noindent
%More precisely, 
Let $b_\bot : Q \times Q \to \Semiring$ be such that: %the function:
%
...
\mynote{detail with nb tr. and states}
...
commutative, bounded, and complete \mynote{total?} semiring  
