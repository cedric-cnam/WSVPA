...
the operators on the functions of labels theories
and properties of complete semirings. % in Section~\ref{sec:prelim}.

\begin{lemma} \label{lem:label-th}
For a label theory $\bar\Phi$ over a complete semiring $\Semiring$, 
