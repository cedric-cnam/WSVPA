...
$\bigoplus_\Deltac b_\top(q_1, q_2)$ can be put in the form:
\[
{\textstyle\bigoplus_\Deltac} b_\top(q_1, q_2) = 
...
\]
and hence 
\( {\textstyle\bigoplus_\Deltac} b_\top(q_1, q_2) = \bigotimes_{i=i}^n w_i(\tau_i) \),
using $c \in \Deltac$ that minimize...
