...
\noindent
More precisely, the \SWT~$T$ defines a mapping 
from the pairs of words of $\Sigma^* \times \Delta^*$ into~$\Semiring$,
...
\[
\begin{array}{lccl}
\weight_T(q, \epsilon, \epsilon, q)  & = & \multicolumn{2}{l}{\final(q)}\\
...
The above sum may be infinite because of the third line.
