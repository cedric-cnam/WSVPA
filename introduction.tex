...
The latter case is related to a case study that motivated the present work: 
automated music transcription.
In this problem, a symbolic representation of a music performance, % a symbolic representation of a music performance 
in the form of a sequence of timed musical events, % timestamped
is converted into a structured score in Common Western Music Notation.
It can therefore be expressed as a parsing problem~\cite{foscarin:hal-01988990}, 
...
It is based on symbolic weighted  (SW) finite states language models generalizing 
...
In the transition rules of SW models, input symbols appear as variables %(parameters)
...
(Bar-Hillel construction~\cite{GruneJacobs08parsing} \marginpar{chap. intersection in~\cite{GruneJacobs08parsing}}) 
