...
as input a linear repreentation (audio or MIDI) and aims at re-constructing
these structures
...
over an infinite alphabet of timed events. Throughout the paper we will
illustrate our framework with examples taken for this motivating application.
