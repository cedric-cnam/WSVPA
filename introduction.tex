...
\florent{Both WA and SA generalized \cite{Herrmann16dlt,Herrmann20phd}...
         we present results...}
...
\florent{Moreover, application parsing. believe results appliable to other decision pb.}
