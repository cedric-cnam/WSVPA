...
\florent{\cite{MorbitzVogler19weighted-parsing} much is more general}
...
a \SWVPA $B$ %$A_{T, s}$ 
is built, such that for all~$t$,  $B(t) = T(s, t) \otimes A(t)$.% $A_{T, s}(t) = T(s, t) \otimes A(t)$.
