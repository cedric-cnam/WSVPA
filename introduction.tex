...
\mynote{I think that we can make the case for a larger set of situations: given a linear 
...
\mynote{register: skip refs and details, add Mikolaj recent}
...
\mynote{chap. intersection in~\cite{GruneJacobs08parsing}} 
...
% value in a semiring...
\mynote{expressiveness: VPA have restricted equality test. 
