...
Regarding the latter case, we briefly mention
at the end of the paper 
a parse-based approach to automated music transcription~\cite{foscarin:hal-01988990}
that motivated the present work. 
In this problem, a symbolic music performance, 
